...
SOURCES = {
    ...
    "GDP_ANNUAL_YY": {
        ...
        "url": f"{NBB_BASE}/A.2.B1GM.VZ.LY.N?startPeriod=2000&dimensionAtObservation=AllDimensions",
        "frequency": "A",
        "unit": "percent_yy",
        "source_agency": "NBB",
        "description": "Year-on-year volume change of GDP, annual",
    },
    "PRIV_CONSUMPTION_YY": {
        "name": "Private Final Consumption",
        "url": f"{NBB_BASE}/A.2.P31_S14_S15.VZ.LY.N?startPeriod=2000&dimensionAtObservation=AllDimensions",
        "frequency": "A",
        "unit": "percent_yy",
        "source_agency": "NBB",
        "description": "Private final consumption expenditure, annual Y-Y volume change",
    },
    "GOV_CONSUMPTION_YY": {
        "name": "Gov. Consumption Expenditure",
        "url": f"{NBB_BASE}/A.2.P3_S13.VZ.LY.N?startPeriod=2000&dimensionAtObservation=AllDimensions",
        "frequency": "A",
        "unit": "percent_yy",
        "source_agency": "NBB",
        "description": "Final consumption expenditure of general government, annual Y-Y volume change",
    },
    "GFCF_DWELLINGS_YY": {
        "name": "Gross Fixed Capital Formation — Dwellings",
        "url": f"{NBB_BASE}/A.2.P51_DWE.VZ.LY.N?startPeriod=2000&dimensionAtObservation=AllDimensions",
        "frequency": "A",
        "unit": "percent_yy",
        "source_agency": "NBB",
        "description": "Gross fixed capital formation in dwellings, annual Y-Y volume change",
    },
    "CHG_STOCKS_YY": {
        "name": "Changes in Stocks",
        "url": f"{NBB_BASE}/A.2.P52.VZ.LY.N?startPeriod=2000&dimensionAtObservation=AllDimensions",
        "frequency": "A",
        "unit": "percent_yy",
        "source_agency": "NBB",
        "description": "Changes in inventories + acquisitions less disposals of valuables, annual Y-Y contribution",
    },
    "NET_EXPORTS_YY": {
        "name": "Net Exports",
        "url": f"{NBB_BASE}/A.2.B11.VZ.LY.N?startPeriod=2000&dimensionAtObservation=AllDimensions",
        "frequency": "A",
        "unit": "percent_yy",
        "source_agency": "NBB",
        "description": "External balance of goods and services, annual Y-Y contribution",
    },
    "GFCF_ENTERPRISES_YY": {
        "name": "Gross Fixed Capital Formation — Enterprises",
        "url": f"{NBB_BASE}/A.2.P51_ENT.VZ.LY.N?startPeriod=2000&dimensionAtObservation=AllDimensions",
        "frequency": "A",
        "unit": "percent_yy",
        "source_agency": "NBB",
        "description": "Gross fixed capital formation by enterprises and self-employed, annual Y-Y volume change",
    },
    "GFCF_PUBLIC_YY": {
        "name": "Gross Fixed Capital Formation — Public Admin",
        "url": f"{NBB_BASE}/A.2.P51_PAD.VZ.LY.N?startPeriod=2000&dimensionAtObservation=AllDimensions",
        "frequency": "A",
        "unit": "percent_yy",
        "source_agency": "NBB",
        "description": "Gross fixed capital formation by public administrations, annual Y-Y volume change",
    },
}
