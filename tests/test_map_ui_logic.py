...
# among them; both are now redirect stubs (repo cleanup) with no map of their
# own, so they no longer belong on this list.
MAP_PAGES = [MAP_HTML, HOME2_HTML, COMMUNE_HTML, PROFILES_HTML]
